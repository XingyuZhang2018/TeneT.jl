...
- Remote workdir: `/sofia/scratch/pilot/pilot_2026_0002/xz/TeneT_codex_2a4a_20260616_225907_tsqr/project/2026-06-17_041200_sofia_plaq_j1j2_J2-0.5_0.52_D16_chi768No20_obs_768_1024_2048_64g_after1287390_resubmit`
- Slurm ID: 1287393
- Dependencies: none live; submitted with `afterany:1287390`, then cleared by `scontrol update JobId=1287393 Dependency=` at user request.
...
- Resubmission note: prior Slurm job `1287391` was cancelled by `DependencyNeverSatisfied` because `afterok:1287376` was not satisfied; this resubmit removes the `1287376` afterok dependency. It was initially submitted with `afterany:1287390`, then the live dependency was cleared so it can run immediately.
