...
# 4-GPU MPI micro-benchmark for ACmap_parallel. Sibling of microbench_mpi.jl.
...
echo "========== 4 GPU MPI ACmap_parallel =========="
srun -n 4 --gpus-per-task=1 bash -c "$BASE_ENVS; exec $JULIA --project=../.. ./microbench_acmap.jl"
