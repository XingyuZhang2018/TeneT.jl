...
# Per-step vumps_step timing to pinpoint the ~105 ms F32 overhead.
...
export D=10; export CHI=400; export FORLOOP_ITER=32; export N=10"

echo "========== 4 GPU MPI vumps_step PROBED =========="
srun -n 4 --gpus-per-task=1 bash -c "$BASE_ENVS; exec $JULIA --project=../.. ./microbench_vumps_probed.jl"
