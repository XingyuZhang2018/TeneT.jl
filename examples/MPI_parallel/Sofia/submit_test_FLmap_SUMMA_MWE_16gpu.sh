#!/bin/bash
#SBATCH --job-name=flmap_summa_mwe_16
...
# SUMMA-FLmap MWE @ 16 GPU (4x4 grid) — see if SUMMA timing scales better
# than 1D as M increases. Persistent memory advantage is 1/M^2 = 1/16.
...
echo "=== test_FLmap_SUMMA_MWE.jl, 16 GPU (4x4 grid), $(date) ==="
