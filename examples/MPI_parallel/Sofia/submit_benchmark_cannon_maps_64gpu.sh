#!/bin/bash -l
#SBATCH --job-name=Sofia_cannon_maps64
...
# 64-GPU (8×8, 8 nodes) cannon MAP timing: FLmap / FRmap / ACmap / ACdmap fwd+bwd,
...
# the NCCL col/reduce-scatter path. Driver: ../benchmark_cannon_maps_sofia.jl with
# TENET_CANNON_N1=N2=8. Results → Sofia_VUB_H200.md (NCCL scaling).
...
export TENET_CANNON_N1=8; \
export TENET_CANNON_N2=8; \
...
echo "=== Sofia 64-GPU (8×8, 8 nodes) cannon MAP timing (FL/FR/AC/ACd) — RING vs NCCL ==="
echo "Start: $(date)"
