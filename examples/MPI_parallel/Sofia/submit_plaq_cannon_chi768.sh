...
# Cannon (block-distributed χ) Plaquette J1J2 Square — D16 χ768 16-GPU (2 nodes × 8 H200, 4×4 grid).
# Loads the converged J2=0.5 D16 χ512 No.50 from the production TeneT.jl/data tree, optimizes at
# χ768 from the TeneT_m3gate clone (has M3–M6: cannon boundary + distributed energy_value).
#
...
echo "=== Cannon Plaquette D=${D:-16} J2=${J2:-0.5} χ${CHI_LOAD:-512}→χ${CHI_OPT:-768} OPT_MAXITER=${OPT_MAXITER:-0} forloop=${FORLOOP_ITER:-16} ==="
