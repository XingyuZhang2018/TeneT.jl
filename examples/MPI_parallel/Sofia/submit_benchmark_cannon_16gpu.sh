#!/bin/bash -l
#SBATCH --job-name=Sofia_cannon_bench16
...
# Cannon 4×4 (16 GPU, 2 nodes) vs slice FLmap benchmark over the Part-2 D×χ
...
# scatter/allgather) cross the IB link. Driver: ../benchmark_cannon_sofia.jl
# with TENET_CANNON_N1=4 TENET_CANNON_N2=4.
...
echo "=== Sofia 16-GPU (2-node) Cannon 4x4 vs slice benchmark ==="
echo "Start: $(date)"
