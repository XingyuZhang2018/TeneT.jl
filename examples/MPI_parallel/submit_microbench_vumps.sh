...
# Micro-benchmark: single vumps_step (leftenv+ACenv+Cenv+QR) in F64 vs F32.
# Compares to isolated FLmap_parallel to locate the non-kernel overhead.
...
export D=10; export CHI=400; export FORLOOP_ITER=32; export N=8"

echo "========== 4 GPU MPI vumps_step =========="
srun -n 4 --gpus-per-task=1 bash -c "$BASE_ENVS; exec $JULIA --project=../.. ./microbench_vumps_step.jl"
