...
# 4-GPU MPI micro-benchmark of FLmap_parallel(ifparallel=true).
# Directly measures the parallel() code path (with allgatherv) in F64 vs F32.
...
export D=10; export CHI=400; export FORLOOP_ITER=32; export N=30"

echo "========== 4 GPU MPI FLmap_parallel =========="
srun -n 4 --gpus-per-task=1 bash -c "$BASE_ENVS; exec $JULIA --project=../.. ./microbench_mpi.jl"
