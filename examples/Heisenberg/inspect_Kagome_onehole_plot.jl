...
A_raw = init_ipeps(; atype=Array, etype=Float64, No=0, D=D, χ=χ_init, params=params)
A = TeneT.build_A(A_raw, params)
rt = TeneT.initialize_env(A_raw, D, χ_init, params)
...
TeneT.plot_lattice_obs(e_dict, m_dict, model.lattice, pattern;
                       save_path=folder, save_format="png", χ=χ_init,
                       e_scalar=real(e), mag_scalar=M_mean)
println("plot: ", joinpath(folder, "lattice_χ$χ_init.png"))
